# -*- coding: utf-8 -*-
"""
Created on Wed Mar 18 14:06:53 2015
...
class KaggleWord2VecUtility(object):
    ...
    @staticmethod
    def review_to_wordlist(review, remove_stopwords=False, remove_punctuation=False):
    ...
    @staticmethod
    def review_to_sentences(review, tokenizer, remove_stopwords=False, remove_punctuation=False):
        ...
        for raw_sentence in raw_sentences:
            if len(raw_sentence) > 0:
                ...
                sentences.append(KaggleWord2VecUtility.review_to_wordlist(raw_sentence, remove_stopwords, remove_punctuation))
